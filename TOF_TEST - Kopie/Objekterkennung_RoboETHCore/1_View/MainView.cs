...
namespace Objekterkennung
{
    public partial class MainView : Form
    {
        ...
        {
            // 1. Pipeline entsperren und neu starten
            this.derController.GetRoboter()?.Pipeline.ResetSystem();

            // 2. WICHTIG: Den Roboter physisch neu referenzieren!
            // Erst nach einem OG darf er wieder MP-Befehle erhalten.
            this.derController.GetRoboter()?.Pipeline.Enqueue("OG", 20000, "RECOVERY: Bezugspunkt anfahren");

            MessageBox.Show("System zurückgesetzt. Roboter fährt Referenzfahrt...");
        }
        //{
        //try
        // {
        ...
        {
            this.derController.GetRoboter()?.Pipeline.EmergencyStopAndClear();
            MessageBox.Show("Not-Aus aktiv! Roboter gesperrt. Bitte Fehler beheben und 'Reset' drücken.");
        }
    }
}
