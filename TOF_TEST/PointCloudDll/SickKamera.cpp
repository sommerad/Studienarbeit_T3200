...
//
//
//ExitCode runWelcomeDemo(visionary::VisionaryType visionaryType, const std::string& ipAddress)
//{
...
//
//
int Kamera::mainFunktion(int argc, char* argv[])
{
    
    std::string deviceIpAddr{ "169.254.235.248" };
