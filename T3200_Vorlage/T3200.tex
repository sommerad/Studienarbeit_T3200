...
\begin{tabbing}
	...
	% Definiere den Abstand: Hier ca. 3.5cm für die Abkürzung
	...
	WH \> Where (Befehl zur Positionsabfrage)\\
	YCbCr \> Farbmodell für Bild- und Videoaufzeichnungen\\
...
\begin{itemize}
	...
	\item \textbf{Software:} OpenCV Bibliothek, Visual Studio (C++ und \csharp), RoboETH, drawIO (Erstellung von Grafiken), texStudio, uEye-Cockpit und IDS Kameramanager, GitHub (Kollaboratives Arbeiten und Versionsverwaltung der LaTeX-Vorlage), MATLAB 2025, GitHub CoPilot.
\end{itemize}
...
\begin{table}[H]
	...
	\begin{tabular}{|p{3cm}|p{6cm}|p{2.5cm}|}
		...
		{Github CoPilot mit Gemini API} & {Programmiersyntax und Formatierung der Projektmappe, IntelliSense-Erweiterung, Refactoring der Klassen "Roboter.cs, Befehlspipeline.cs, Controller.cs und Bildverarbeitung.cs} & {Visual Studio-Projektmappe} \\ \hline
	\end{tabular}
\end{table}
\newpage
...
\begin{tabularx}{\textwidth}{|X|l|l|}
	...
	Verwaltung von Punktwolken & \ref{kap:Verwaltung der Punktwolke-Daten} & \autor \\ \hline
	Sequenzielle Befehlsstruktur  & \ref{kap:Sequenzielle Befehelsstruktur} & \autorzwei \\ \hline
	Konzeptionierung der dynamischen Robotersteuerung & \ref{kap:Konzeptionierung der dynamischen Robotersteuerung} & \autorzwei \\ \hline
	Safetyimplementation & \ref{Sichere Mensch-Roboter-Kolaboration} & \autor \\ \hline
	Befehlspipeline & \ref{kap:befehlspipeline} & \autorzwei \\ \hline
	Integration der Safety-Implementation in die Befehlspipeline & \ref{kap:Integration der Safety-Implementation in die Befehlspipeline} & \autorzwei \\ \hline
...
\begin{itemize}
	\item Änderung zu PCL-Verwaltung (Luis Thiel)
	\item gesamter LaTeX-Ordner
	\item MATLAB-Livescript für die Berechnung der Objekt-Verfahrzeiten
	\item relevante .cs-Dateien (Roboter, Befehlspipeline, Controller, Bildverarbeitung)
	\item Link zur vollständigen Projektmappe
\end{itemize}
\newpage
